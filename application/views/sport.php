...
<body>
  ...
  <div class="banner_edu">
    <img src="<?php echo base_url();?>assets/Images/focus_image/sport_banner.jpg" class="img-fluid"><br><br>
    <h3 class="wow fadeInUp toc_mainText">Sports</h3>
    <hr>
  ...
  <div id="image_mbs">
    <div class="kotak_grey">
      <h2 class="wow fadeInUp main_text">Lamongan<br>Beach<br>Run</h2>
    </div>
    <img src="<?php echo base_url();?>assets/Images/focus_image/lbr_img.jpg" class="wow fadeInUpBig" id="mbs"><br><br>
    ...
    <div id="image_mbs">
      <div class="kotak_grey">
        <h2 class="wow fadeInUp main_text">Segoroyoso<br>Cup</h2>
      </div>
      <img src="<?php echo base_url();?>assets/Images/focus_image/segoroyoso_img.jpg" class="wow fadeInUpBig" id="mbs"><br><br>
      <p class="wow zoomIn mbs_text">"But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, the master-builder of human happiness. No one rejects, dislikes, or avoids pleasure itself, because it is pleasure, but because those who do not know how to pursue pleasure rationally encounter consequences that are extremely painful. Nor again is there anyone who loves or pursues or desires to obtain pain of itself, because it is pain, but because occasionally circumstances occur in which toil and pain can procure him some great pleasure. To take a trivial example, which of us ever undertakes laborious physical exercise, except to obtain some advantage from it? But who has any right to find fault with a man who chooses to enjoy a pleasure that has no annoying consequences, or one who avoids a pain that produces no resultant pleasure?":<br><br></p>
    </div>
    <div id="image_mbs">
      <div class="kotak_grey">
        <h2 class="wow fadeInUp main_text">Karang Taruna<br>Volley Ball<br>Competition</h2>
      </div>
      <img src="<?php echo base_url();?>assets/Images/focus_image/kartar_cup.jpg" class="wow fadeInUpBig" id="mbs"><br><br>
      <p class="wow zoomIn mbs_text">"But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, the master-builder of human happiness. No one rejects, dislikes, or avoids pleasure itself, because it is pleasure, but because those who do not know how to pursue pleasure rationally encounter consequences that are extremely painful. Nor again is there anyone who loves or pursues or desires to obtain pain of itself, because it is pain, but because occasionally circumstances occur in which toil and pain can procure him some great pleasure. To take a trivial example, which of us ever undertakes laborious physical exercise, except to obtain some advantage from it? But who has any right to find fault with a man who chooses to enjoy a pleasure that has no annoying consequences, or one who avoids a pain that produces no resultant pleasure?":<br><br></p>
    </div>
    <!--- END CONTENT-->
    <!--- START GRAND DESIGN -->
    ...
    <div class="container grand_design">
      <div class="wow slideInUp box_gds">
        ...
        <div class="content">
          <h3 class="fase">Lamongan Beach Run</h3>
          <p class="textFase">- English Traning<br>- Balanced Nutrition and A Clean and Healthy Lifestyle<br>- Self Quality Development through Inspiration Class</p>
        </div>
      </div>
      <div class="wow slideInUp box_gds">
        <div class="icon">02</div>
        <div class="content">
          <h3 class="fase">Segoroyoso Cup</h3>
          <p class="textFase">- RPTRA Kemuning for various activities such as children’s games<br>- Sports<br>- Reading<br>- Counseling for mothers<br>- Education</p>
        </div>
      </div>
      <div class="wow slideInUp box_gds">
        <div class="icon">03</div>
        <div class="content">
          <h3 class="fase">Karang Taruna Cup</h3>
          <p class="textFase">- Tambun Raya Village established community business units<br>-  Social activities conducted by Karang Taruna Tambun Raya</p>
        </div>
      </div>
    </div>
    <!--- END GRAND DESIGN -->
