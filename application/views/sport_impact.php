...
<!-- End Navbar -->
    ...
    <div class="container-social_impact">
      <div class="bg-image">
        <img src="<?php echo base_url();?>assets/Images/Foto_Dampak/sport_impact.jpg" class="img-fluid impact"><br><br>
        <h3 class="wow fadeInUp toc_mainText">Sport Program</h3>
        <hr width="80%">
      </div>
      <div class="bg-text">
        <h1>Sport Program</h1>
        <br>
        <p>To Encourage Healthy Behavior Through Sport Activities</p>
      </div>
    </div>
    <div class="container-content-1">
      <div class="row">
        <div class="col-md narasi">
          <h3 class="wow fadeInUp" id="about_text">1. Sport Event</h3>
          <br><br>
          <p class="wow zoomIn">- 3.165 people (especially youth aged 15-35) have joined sporting events, organized by JAPFA Foundation.<br><br>- Local Government and communities in Lamongan and Bantul District acknowledged JAPFA Foundation as the main actor in building and developing youth potential in sports (specifically football and volleyball).</p>
        </div>
        <div class="col-md image">
          <div class="container_img_about">
            <img class="wow slideInUp" src="<?php echo base_url();?>assets/Images/Foto_Dampak/sport1_impact.jpg" alt="Avatar" id="image">
          </div>
        </div>
      </div>
    </div>
