...
<div class="container news wow fadeInUp">
    <?php if (!empty($gallery)) {
      ...
      <div class="card news">
        <img src="<?php echo base_url();?>assets/gallery/<?php echo $datagallery['gambar'];?>" style="width:120%">
        <div class="news_text text-center">
            <h5><?php echo $datagallery['descrip'];?></h5>
        </div>
    </div>
    <?php } } ?>
</div>
    ...
    <div class="container footer" id="footer">
        ...
        <div class="row" id="menu-footer">
            <div class="col-md col-sm-3 footer">
                <ul>
                    ...
                    <li><a href="edu_page.html">Focus</a></li>
        ...
        <div class="sosmed_logo">
            <ul class="col-md-7">
                ...
                <li><a target="_blank" href="https://www.facebook.com/japfafoundation/"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                <li><a target="_blank" href="https://www.facebook.com/japfafoundation/"><i class="fa fa-youtube-play" aria-hidden="true"></i></a></li>
